...
The default model is ~~small English spaCy model (en_core_web_sm, 11Mb)~~ German small model (de_core_news_sm) and is installed automaticaly with this package. To use other model you'll have to install it manually.
